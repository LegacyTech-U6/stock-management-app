<template>
  ...
  >
    ...
    <div class="flex items-center justify-between mb-4">
      ...
      <div class="w-10 h-10 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 flex items-center justify-center text-gray-600">
        <slot name="icon">
          <svg v-if="!$slots.icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="w-5 h-5">
    ...
    <div class="flex items-end justify-between">
      ...
      >
        <span :class="percentageIconClass">
          <svg v-if="subtitle.includes('+')" class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
            <path fill-rule="evenodd" d="M12 7a1 1 0 110-2h.01a1 1 0 110 2H12zm-4.08 5a1 1 0 10-1.42-1.41l-2.83 2.83-2.83-2.83a1 1 0 00-1.41 1.41l2.82 2.83-2.82 2.83a1 1 0 101.41 1.41l2.83-2.83 2.83 2.83a1 1 0 001.42-1.41L6.59 12z" clip-rule="evenodd" />
          </svg>

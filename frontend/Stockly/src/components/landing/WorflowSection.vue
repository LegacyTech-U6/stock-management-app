<template>
  <section class="grid grid-cols-10 h-screen overflow-hidden">
    <!-- SECTION GAUCHE (fixe) -->
    <section
      class="col-span-2 flex flex-col justify-center items-center bg-gray-900 text-white sticky top-0 h-screen p-6"
    >
      <h2 class="text-3xl font-semibold mb-4">Stockly Workflow</h2>
      <p class="text-gray-300 leading-relaxed text-center">
        Découvrez comment Stockly automatise chaque étape du processus de vente, du scan à la mise à
        jour du stock.
      </p>
    </section>

    <!-- SECTION DROITE (scroll horizontal) -->
    <section ref="sectionRef" class="col-span-8 overflow-hidden bg-gray-800">
          ...
          >
            <div class="flex items-start space-x-6 min-w-96">
              <div class="flex flex-col items-center">
                <div
                  class="w-16 h-16 bg-white rounded-full flex items-center justify-center mb-4 step-icon shadow-lg relative"
                >
                  <div
...
const steps = [
  { icon: Scan, title: 'Sélection des produits', description: 'Scannez ou recherchez vos produits.' },
  { icon: Calculator, title: 'Calcul automatique', description: 'TVA et remises calculés instantanément.' },
  { icon: FileCheck, title: 'Génération de facture', description: 'Facture professionnelle en un clic.' },
  { icon: Database, title: 'Mise à jour du stock', description: 'Inventaire actualisé en temps réel.' },
]

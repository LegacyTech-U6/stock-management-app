  ...
  >
    <div class="px-6 w-5xl space-x-2 py-4 flex items-center justify-between">
      <div class="flex items-center gap-2">
        <div
          class="w-8 h-8 bg-gray-900 flex items-center justify-center text-white text-sm font-medium"
        >
          S
        </div>
    ...
    <div v-if="isOpen" class="md:hidden px-6 py-6 border-t border-gray-200 space-y-6 bg-white">
      <a
        v-for="item in navItems"
        :key="item"
        href="#"

      ...
      <div class="bg-white rounded-2xl p-6 shadow-sm border border-yellow-100">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold text-gray-900 mt-3">{{ formatPrice(stats.pendingAmount) }}</p>
      ...
      <div class="bg-white rounded-2xl p-6 shadow-sm border border-red-100">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold text-gray-900 mt-3">{{ formatPrice(stats.overdueAmount) }}</p>
    ...
    <div class="bg-white rounded-2xl  border border-gray-200">
      ...
      <div class="flex items-center justify-between p-6 border-b border-gray-100">
        ...
        <div class="flex items-center gap-3 ml-4">
          <button class="p-2 text-gray-600 hover:bg-gray-100 rounded-lg transition-colors flex items-center gap-2 text-sm font-medium">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1v-2z" />
            </svg>
            All Status
          </button>
          <button class="p-2 text-gray-600 hover:bg-gray-100 rounded-lg transition-colors flex items-center gap-2 text-sm font-medium">

<template>
  <div class="p-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
    <StatsCard title="Total Sales" :value="Number(totalSales)" valueColor="text-blue-600" />
    <StatsCard title="Average Revenue" :value="Number(avgRevenue)" valueColor="text-green-600" />
    <StatsCard title="Profit" :value="Number(profit)" valueColor="text-purple-600" />
    <StatsCard
      title="Margin %"
      :value="Number(margin)"

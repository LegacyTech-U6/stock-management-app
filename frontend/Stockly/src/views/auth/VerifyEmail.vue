...
<template>
  <div
    class="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-orange-50 flex items-center justify-center p-4"
  >
    <div class="max-w-md w-full">
      <!-- Success State -->
      <div
        v-if="authStore.successMessage && !authStore.error"
      ...
      >
        ...
        <p class="text-sm text-gray-500 mb-6">
          Your email has been successfully verified. You'll be redirected in
          {{ countdown }} seconds...
        </p>
      ...
      <div v-else-if="authStore.isLoading" class="bg-white rounded-2xl shadow-lg p-8 text-center">
        <!-- Loading Spinner -->
        <div
          class="w-20 h-20 bg-indigo-100 rounded-full flex items-center justify-center mx-auto mb-6"
        >
          <svg
      ...
      <div v-else-if="authStore.error" class="bg-white rounded-2xl shadow-lg p-8 text-center">
        ...
        <p class="text-sm text-gray-500 mb-6">The activation link may be invalid or expired.</p>

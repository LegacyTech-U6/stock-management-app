      ...
      <div class="max-w-7xl mx-auto">
        <div class="flex items-center justify-between">
          ...
          >
            ...
            <button
              :class="viewMode === 'grid' ? 'bg-gray-100' : 'bg-white'"
            ...
            <button
              :class="viewMode === 'list' ? 'bg-gray-900 text-white' : 'bg-white text-gray-700'"
              class="p-2 border border-gray-300 rounded-lg hover:bg-gray-100 transition-colors"
              @click="viewMode = 'list'"
            >
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div class="max-w-7xl mx-auto">
        <div class="flex gap-4">
          ...
          <select
            ...
            class="px-4 py-2.5 border border-gray-300 rounded-lg bg-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
          >
